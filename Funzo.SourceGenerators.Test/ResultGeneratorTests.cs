...
namespace Foo
{
    ...
    {
        public FooBar(global::Foo.Bar.Class1 _) : base(_) {}
        public FooBar(global::Bar.Class2 _) : base(_) {}
        ...
        public new static FooBar Ok(global::Foo.Bar.Class1 ok) => new(ok);
        public new static FooBar Err(global::Bar.Class2 err) => new(err);
    }
}";
